...
if __name__ == "__main__":
	...
	filtered_text_without_whitespaces = filtered_text_with_whitespaces.translate({ord(c): None for c in string.whitespace})
	...
	char_frec_without_whitespace = count_char_frequency(russ_alphabet_without_whitespace,filtered_text_without_whitespaces)
	print("char_frec_without_whitespace:\n-------")
	for i in char_frec_without_whitespace:
		print(i[0],i[1])

	bigram_frec_with_whitespace = count_bigram_frequency(russ_alphabet,filtered_text_with_whitespaces,'bigram_frec_with_whitespace.xls')
	print("bigram_frec_with_whitespace:\n-------")
	for i in bigram_frec_with_whitespace:
		print(i[0],i[1])

	bigram_frec_without_whitespace = count_bigram_frequency(russ_alphabet_without_whitespace,filtered_text_without_whitespaces,'bigram_frec_without_whitespace.xls')
